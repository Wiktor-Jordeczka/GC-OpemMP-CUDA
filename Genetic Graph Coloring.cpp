...
#define inFile "gc1000.txt" // Plik wejściowy
...
int main()
{
    ...
    //const int random_vertices = 25; // ilość losowo pokolorowanych wierzchołków przy tworzeniu populacji
    ...
    const int random_vertices = numOfVertices/10;
